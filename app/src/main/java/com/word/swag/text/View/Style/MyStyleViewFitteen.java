 ...
 */
public class MyStyleViewFitteen extends MyStyleBaseView {
    ...
    public MyStyleViewFitteen(Context context) {
        super(context);
        myStyleViewFitteen = this;
        init();
    }
    ...
    public void customviewThree(){
        ...
        myStyleViewFitteen.addView(baseView_03, layoutParams);
    }

    public void customviewFour(){
        params =  new Params();
        params.setWidth(Width * 9 / 10);
        params.setHeight(Height / 8);
        params.setPaddingTop(10);
        params.setPaddingBottom(10);
        params.setPaddingRight(10);
        params.setPaddingLeft(10);
        params.setRotation(5.0f);
        params.setTypeface(mFont.getRandomTypeface());
        baseView_04 = new MyBaseView(MainActivity.getmContext(), params);
        layoutParams = new FrameLayout.LayoutParams(Width, Height / 8);
        layoutParams.setMargins(Width / 10, Height * 17 / 24, 0, 0);
        myStyleViewFitteen.addView(baseView_04, layoutParams);
    }
    ...
    public void customviewFive(){
        ...
        layoutParams.setMargins(0, Height * 20 / 24, 0, Height/10);
        myStyleViewFitteen.addView(baseView_05, layoutParams);
    }
