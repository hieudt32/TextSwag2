 ...
 */
public class MyStyleViewTen extends MyStyleBaseView {
    ...
    public MyStyleViewTen(Context context) {
        super(context);
        myStyleViewTen = this;
        init();
    }
    ...
    public void customViewOne(){
        ...
        layoutParams.setMargins(rlWidth / 4, 0, 0, 0);
        myStyleViewTen.addView(baseView_01, layoutParams);
    }
    ...
    public void customViewTwo(){
        ...
        myStyleViewTen.addView(baseView_02, layoutParams);
    }
    ...
    public void customViewThree(){
        ...
        layoutParams = new FrameLayout.LayoutParams(rlWidth / 2, rlHeight / 4);
        layoutParams.setMargins(0, rlHeight / 2, rlWidth / 2, 0);
        myStyleViewTen.addView(baseView_03, layoutParams);
    }
    public void customviewFour(){
        ...
        layoutParams.setMargins(rlWidth / 5, rlHeight * 3 / 4, rlWidth / 5, 0);
        myStyleViewTen.addView(baseView_04, layoutParams);
    }
