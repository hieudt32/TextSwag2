 ...
 */
public class MyStyleViewTwenty extends MyStyleBaseView {
    ...
    public MyStyleViewTwenty(Context context) {
        super(context);
        myStyleViewTwenty = this;
    ...
    public void customViewOne(){
        ...
        myStyleViewTwenty.addView(baseView_01, layoutParams);
    }
    ...
    public void customViewTwo(){
        ...
        layoutParams = new LayoutParams(Width * 2 / 3, Height / 3);
        layoutParams.setMargins(Width / 6, Height / 3, Width / 6, 0);
        myStyleViewTwenty.addView(baseView_02, layoutParams);
    }
    ...
    public void customViewThree(){
        ...
        myStyleViewTwenty.addView(baseView_03, layoutParams);
    }

    public int getDrawable(){
        return new ImageSmall().getRandomCircle();
    }
    ...
    public void setBaseViewBg(Context context){
        ...
        myStyleViewTwenty.addView(baseViewBg, layoutParams);
    }
