 ...
 */
public class MyStyleViewTwentyOne extends MyStyleBaseView {
    ...
    public MyStyleViewTwentyOne(Context context) {
        super(context);
        myStyleViewTwentyOne = this;
    ...
    public void customViewOne(){
        ...
        myStyleViewTwentyOne.addView(baseView_01, layoutParams);
    }
    ...
    public void customViewTwo(){
        ...
        myStyleViewTwentyOne.addView(baseView_02, layoutParams);
    }
    ...
    public void customViewThree(){
        ...
        myStyleViewTwentyOne.addView(baseView_03, layoutParams);
    }
    ...
    public void customViewFour(){
        ...
        myStyleViewTwentyOne.addView(baseView_04, layoutParams);
    }

    public int getDrawable(){
        return new ImageSmall().getRandomBadge();
    }
...
//        baseViewBg.setDrawableColor(drawable, TextToolFragment.getColor());
        ...
        myStyleViewTwentyOne.addView(baseViewBg, layoutParams);
    }
