 ...
 */
public class MyStyleViewTwentySix extends MyStyleBaseView {
    ...
    public MyStyleViewTwentySix(Context context) {
        super(context);
        myStyleViewTwentySix = this;
    ...
    public void customViewOne(){
        ...
        params.setHeight(rlHeight * 2 / 7);
        params.setPaddingRight(10);
        params.setPaddingLeft(10);
        params.setPaddingTop(20);
        params.setPaddingBottom(20);
        params.setTypeface(mFont.getRandomTypeface());
        if (baseView_01 == null)baseView_01 = new MyBaseView(MainActivity.getmContext(), params);
        layoutParams = new FrameLayout.LayoutParams(rlWidth / 2, rlHeight * 2 / 7);
        layoutParams.setMargins(rlWidth / 4, rlHeight / 7, rlWidth / 4, 0);
        myStyleViewTwentySix.addView(baseView_01, layoutParams);
    }

    public void customViewTwo(){
        params =  new Params();
        params.setWidth(rlWidth * 5 / 6);
        ...
        layoutParams = new FrameLayout.LayoutParams(rlWidth * 5 / 6, rlHeight / 7);
        layoutParams.setMargins(rlWidth / 12, rlHeight * 3 / 7, rlWidth / 12, 0);
        myStyleViewTwentySix.addView(baseView_02, layoutParams);
    }

    public void customViewThree(){
        params = new Params();
        params.setWidth(rlWidth * 4 / 6);
        params.setHeight(rlHeight / 7);
        params.setPaddingRight(10);
        params.setPaddingLeft(10);
        params.setPaddingTop(20);
        ...
        layoutParams = new FrameLayout.LayoutParams(rlWidth * 4 / 6, rlHeight / 7);
        layoutParams.setMargins(rlWidth / 6, rlHeight * 4 / 7, rlWidth / 6, 0);
        myStyleViewTwentySix.addView(baseView_03, layoutParams);
    }

    public int getDrawable(){
        return new ImageSmall().getRandomTemp26();
    }
...
//        baseView_bg.setDrawableColor(drawable, TextToolFragment.getColor());
        ...
        myStyleViewTwentySix.addView(baseView_bg, layoutParams);
    }
